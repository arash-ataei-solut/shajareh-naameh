...
from persons.views import PersonAddView, FindMyselfView, PersonUpdateViewOrIsOwner, PersonDetailView, PersonAddMyselfView, \
...
urlpatterns = [
    ...
    path('person-update/<int:pk>/', PersonUpdateViewOrIsOwner.as_view(), name='person-update'),
